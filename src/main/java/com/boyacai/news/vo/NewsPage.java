...
public class NewsPage {
	...
	protected List<News> news = new ArrayList<News>();//记录列表

	//-- 构造函数 --//
	public NewsPage() {
	}

	public NewsPage(int pageSize) {
	 ...
	 */
	public NewsPage pageNo(final int thePageNo) {
		setPageNo(thePageNo);
		return this;
	}
	 ...
	 */
	public NewsPage pageSize(final int thePageSize) {
