...
public class JSONReslutUtil {
	...
	public static String getSelectJSONArray(JSONObject para, JSONObject where,
		...
		logger.info(baseUrl + action + ";jsessionid=" + sessionid
				+ "?method=" + method + "&jsonString=" + paras + "&jsonWhere="
				+ wheres);
		// 调用接口发送到后台
	...
	public static JSONObject getUserNo(HttpServletRequest request){
		...
		if(jsessionid != null){
			try {
				String 	obj = getResultMessage(usersCenterUrl+"user/center!getUserNo;jsessionid="+jsessionid+"?","a="+Math.random(),"POST");
	...
	public static JSONObject getUserInfo(HttpServletRequest request){
		...
		if(jsessionid != null){
			try {
				String obj = getResultMessage(usersCenterUrl+"user/center!getUserInfo;jsessionid="+jsessionid+"?","a="+Math.random(),"POST");
	...
	public static void logoutUser(HttpServletRequest request){
		...
		if(jsessionid != null){
			try {
				getResultMessage(usersCenterUrl+"user/center!logout;jsessionid="+jsessionid+"?","a="+Math.random(),"POST");
			} catch (IOException e) {
	...
	public static String changeUserInfo(HttpServletRequest request){
		try {
			...
			if(jsessionid != null){
				...
				JSONObject js = JSONObject.fromObject(getResultMessage(usersCenterUrl+"user/center!editUserInfo;jsessionid="+jsessionid+"?","a="+Math.random()+"&userinfo="+userinfo.toString(),"POST"));
