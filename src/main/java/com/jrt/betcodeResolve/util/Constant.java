...
public class Constant {
	...
	public static final String EEXW = "T01013"; //22xuan5
	
	public static final String QXC = "T01009";  //qixingcai
	...
	public static final String SYXW_HH ="T01014";//11选5混合玩法
	public static final String SYXW_DM ="XYXW_23009"; //江西11选5
	
	public static final String SYYDJ ="T01012";//十一运夺金
	
	public static final String JCZQ_RSPF = "J00013";//竞彩足球让球胜平负
	...
	public static final String JCZQ_HH = "J00011";//竞彩zu球混合
	public static final String JCLQ_HH = "J00012";//竞彩篮球混合
	public static final String  NMKS = "F47107";//内蒙快三
	/**
	 * 双色球玩法
	 */
	 ...
	 * 内蒙快三玩法
	 */
	public static final String 	NMKS_HZ = "10";// HEZHI
	public static final String NMKS_STHTX = "40";// 三同号通选（三同号全选
	public static final String NMKS_STDS = "02";//（三同单式）  02
	public static final String NMKS_STMS = "81";//三同 复式(81)
	public static final String NMKS_ERTHMS= "30";//二同号复选（二同号投注）
	public static final String NMKS_ERTDS = "01";// 二同单式
	public static final String NMKS_ERTZH = "71";// 二同组合
	public static final String NMKS_ERBTZH = "21";// 二不同Z组合
	public static final String NMKS_ERBT = "20";// 二不同号
	public static final String NMKS_ERBTHDT = "22";// 二不同号胆拖
	public static final String NMKS_SBTHDS = "00";// 三不同DAN式
	public static final String NMKS_SBTHMS = "63";// 三不同复式
	public static final String NMKS_SBTHDT = "64";// 三不同胆拖
	public static final String NMKS_SLHTX = "50";// 三连号通选
...
//	public static final String SD_ZXFS = "03";// 直选复式
	...
	public static final String UMPAY_BANKID_MOBILE = "ump002";//联动优势手机话费充值
	...
	public static final String ZFB_CARDTYPE_MS="CMBC";//民生银行
	...
	public static final String ZFB_CARDTYPE_PA="SPABANK";//平安银行
