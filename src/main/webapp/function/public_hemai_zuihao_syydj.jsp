					...
					<tr>
						...
						<td style="padding-right:0px;">
							<ul>
								...
								<li><input type="checkbox" checked="checked" id="fengxiang"/>我已阅读并同意<span class="buy_blue"><a href="/rchlw/function/rules/syydjRisk.jsp" title="限号管理" target="_blank">限号管理</a></span>和<a class="light" href="/rchlw/function/rules/syydjRisk.jsp" target="_blank">《十一运夺金投注风险须知》</a>。</li>
							</ul>
						</td>
