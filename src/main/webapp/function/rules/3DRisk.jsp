...
<div class="xieyi2">
<p class="dd">福彩3D投注风险须知</p>
<br />
<ul><li>1、彩票发行和销售机构对每期投注号码的可投注数量实行动态控制（又称“限号”），您发起的方案（包括追号方案）中若包含被限号的号码，该方案将因限号无法投注，网站将做撤单返款处理。</li><li>2、因限号而导致的部分或全部无法投注成功的方案，网站在当期官方截止时间之前进行当期方案的撤单并及时返款操作。</li><li>3、因限号导致的无法投注成功，网站履行在当期官方截止时间之前撤单并及时返款义务，除此之外，网站对于包括但不限于方案是否中奖等事项不承担任何责任。</li></ul>
<p><br /><br /></p>
<p class="dd">限号管理</p>
<br />
