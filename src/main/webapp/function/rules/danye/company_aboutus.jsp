...
<div class="main_contain">
	<div class="main_left">
		<h1>公司简介</h1>
		<ul id="left_menu">
			<li><a href="#" class="click">关于我们</a></li>
			<li><a href="company_idea.jsp">经营理念</a></li>
			<li><a href="company_president.jsp">总裁致辞</a></li>
			<li><a href="company_advantage.jsp">我们的优势</a></li>
			<li><a href="company_contactus.jsp">联系我们</a></li>
	...
	<div class="main_right">
		...
		<div class="main_right_txt">
			<p>公司致力于为彩票发行机构提供行业领先的无纸化彩票解决方案 和 高度流程化的运营服务，完善的风险控制管理和客户关系管理 ，为福利彩票、体育彩票事业的无纸化运营创新贡献力量。</p>
		</div>
		<h2>企业愿景</h2>
		<div class="main_right_txt">
			<p>以虔诚的态度 、专业的能力 、精湛的管理为 广大彩民 提供服务。</p>
		</div>
		<h2>企业精神：</h2>
		<div class="main_right_txt">
			<ul>
				<li>诚信负责：遵守商业道德和职业操守 ，推进负责任的彩票专业运营！ </li>
				<li>立志领先： 大力钻研产品和技术，立志为彩民提供最优质的服务！ </li>
				<li>务实创新：积极迎接挑战，鼓励 产品和技术创新，推动行业发展！ </li>
				<li>专业精神： 荟萃各方精英，积累中外经验，提升专业水平！ </li>
				<li>团队合作：尊重不同文化，包含各种观念，提倡平等沟通，发挥团队精神！ </li>
				<li>以人为本：员工是我们最珍贵的资源， 团队使我们最宝贵的资产！ </li>
			</ul>
		</div>
	</div>
