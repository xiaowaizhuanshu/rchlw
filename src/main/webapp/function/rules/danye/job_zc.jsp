...
<div class="main_contain">
	<div class="main_left">
		...
		<ul id="left_menu">
			...
			<li><a href="job_cp.jsp">产品运营类</a></li>
			<li><a href="job_kf.jsp">客户服务类</a></li>
			<li><a href="job_zc.jsp" class="click">内容编辑类</a></li>
		</ul>
		<div class="left_kefu">
		...
		<div class="job_contain">
			...
			<ul>
				<li>					1、负责网站日常资讯的筛选、加工、完善、发布工作；&nbsp;<br />
					2、负责网站的内容建设以及维护；&nbsp;<br />
					3、针对网站开展的专题营销活动协助策划及方案撰写；&nbsp;<br />
					4、负责热点事件的内容加工、站内宣传。&nbsp;
					<div>岗位要求：</div>
					<p >1、中文、广告传媒等相关专业；&nbsp;<br />
						2、2年以上资讯类网站编辑工作经验；&nbsp;<br />
						3、较为扎实的文字功底，文案撰写能力较强；&nbsp;<br />
						4、熟练使用各种办公软件，会用PHOTOSHOP等进行简单的图片编辑、修改制作<br />
						5、积极好学，具备责任心和团队协作精神；<br />
						6、有彩票类网站相同任职背景优先考虑；&nbsp; </p>
					<p >7、薪酬福利待遇面议。 </p>
					<br />
				</li>
			</ul>
