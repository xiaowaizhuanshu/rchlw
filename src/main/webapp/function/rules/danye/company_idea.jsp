...
<div class="main_contain">
	<div class="main_left">
		...
		<ul id="left_menu">
			<li><a href="company_aboutus.jsp">关于我们</a></li>
			<li><a href="#" class="click">经营理念</a></li>
			<li><a href="company_president.jsp">总裁致辞</a></li>
			<li><a href="company_advantage.jsp">我们的优势</a></li>
			<li><a href="company_contactus.jsp">联系我们</a></li>
		</ul>
	...
	<div class="main_right">
		...
		<div class="main_right_txt">
			<ul>
				<li>以无纸化购彩为核心，拓展移动商务，创造合作共赢！</li>
				<li>手机客户端、WAP、自助终端、手持终端、彩票购买代理服务等无纸化渠道！</li>
				<li>更多选择，更多自由，更多价值！</li>
			</ul>
		</div>
		<div class="main_right_txt">
			<p>&nbsp;</p>
			<p align="center"><img src="<%=request.getContextPath() %>/function/images/danye/youshi.jpg" width="605" height="553" /></p>
		</div>
	</div>
