...
<div class="main_contain">
	<div class="main_left">
		...
		<ul id="left_menu">
			<li><a href="job.jsp">技术研发类</a></li>
			<li><a href="job_cp.jsp">产品运营类</a></li>
			<li><a href="job_kf.jsp" class="click">客户服务类</a></li>
			<li><a href="job_zc.jsp">内容编辑类</a></li>
		</ul>
		<div class="left_kefu">
	...
	<div class="main_right">
		...
		<div class="job_contain">
			...
			<ul>
				<li>
					<p >1.负责收集用户对软件产品的需求与反馈，与相关人员进行技术沟通，回答用户使用过程中的相关问题. </p>
					<p >2.电话回访客户，维护好与客户之间的良好关系，促进公司于客户的长期合作. </p>
					<p >3.热情解答客户咨询，并为客户提供优质的服务，维护公司形象.<br />
						4.详细记录客户信息，并及时把相关信息反馈给主管领导或相关部门.<br />
						5.讲究团队合作精神，与同事相互支持、互相帮助、共同进步，杜绝我行我素等不良行为.<br />
					</p>
				</li>
			</ul>
			<div>岗位要求：</div>
			<ul>
				<li>
					<p >1.口齿清晰、普通话流利、有较强的表达能力和沟通能力.<br />
						2.性格开朗、喜欢沟通和交流.<br />
						3.应变能力强，敢于挑战困难和挫折.<br />
						4.对互联网较为了解，熟悉办公软件操作，熟练使用EXCEL表格.<br />
						5.有电话营销、网络产品销售、广告业务等相关工作经验者优先.<br />
						6.有团队合作精神，有强烈的责任心、敬业精神，能吃苦耐劳，积极完成工作. </p>
				</li>
			</ul>
		</div>
	</div>
