...
<script>$(function(){toplogo('common',"ButtonChannelBuy");});</script>
 <span id="common"></span>
  <div class="chzhsuc_main">
   	  <div class="chzhsuc_top" style="margin:50px 0px 0px 230px;">
   	  <span class="chzhsuc_img"><img src="/rchlw/function/images/err.gif"  /></span>
   	  <span class="chzhsuc_zi">真遗憾<span id="nick_name"><script>check_nickName();</script></span>，您的方案提交失败！</span>
   	  <div class="chzhsuc_zi">
   	     <span id="msgDIV"><script>tishiMsg("msgDIV");</script></span>
   	  </div>
   	  </div>
   	  <style>
   	  .chzhsuc_other a{color:#0F3F94; text-decoration:underline;}
   	  </style>
   	  <div class="chzhsuc_other" style="margin-left:350px;">您还可以<span id="jxtz"><script>getCaiZhong("scai","jxtz")</script></span>。</div>　
