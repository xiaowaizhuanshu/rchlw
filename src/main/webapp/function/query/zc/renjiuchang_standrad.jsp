...
<!-- 			<td class="zucai_biao1" width="90" rowspan="2">分析/预测</td> -->
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="49"><img src="<%=request.getContextPath() %>/function/images/quan_3.gif"
				onclick="selectSingleAll9(3)" />
			</td>
			<td class="zucai_biao2" width="49"><img src="<%=request.getContextPath() %>/function/images/quan_1.gif"
				onclick="selectSingleAll9(1)" />
			</td>
			<td class="zucai_biao2" width="50"><img src="<%=request.getContextPath() %>/function/images/quan_0.gif"
