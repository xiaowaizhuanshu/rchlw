...
<link href="<%=request.getContextPath() %>/function/css/new-pro-kaijiang.css" type="text/css" rel="stylesheet" />
...
<!--开奖中心右边-->	
<jsp:include page="/function/query/lotteryInfo_Zc.jsp"></jsp:include>
