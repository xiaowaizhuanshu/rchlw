		...
		<div class="my_account">
			...
			<table class="account_day"  cellspacing="0" cellpadding="0">
				...
				<s:else><tr class="accountDay_greyBg"></s:else>
					...
					<td><s:if test='presentDetails.lotno=="J00013"||presentDetails.lotno=="J00001"'>-</s:if>
					  <s:else><s:property value="torder.batchcode"/></s:else>
					</td>
					...
					<td><a href='<%=request.getContextPath() %>/function/rules/oneBetInfo.jsp?flowno=<s:property value="presentDetails.orderid"/>&play_name=<s:property value="presentDetails.lotno"/>&batchcode=<s:property value="presentDetails.batchcode"/>&type=1'  target="_blank">查看</a></td>
				</tr>
				</s:iterator>
				</s:if>
				...
				<s:else><tr class="accountDay_greyBg"></s:else>
				  ...
				  <s:elseif test='presentDetails.lotno=="J00013"'>竞足让球胜平负</s:elseif>
					...
					<%/* 期号  */ %>
					<td><s:if test='presentDetails.lotno=="J00013"||presentDetails.lotno=="J00001"'>-</s:if><s:else><s:property value="presentDetails.batchcode"/></s:else></td>
					<td><s:property value="presentDetails.nickName"/></td>
					<td>¥<s:property value="torder.amt"/></td>
					<td><s:property value="presentDetails.createtime"/></td>
					<td>
				...
				<s:else><tr class="accountDay_greyBg"></s:else>
				   ...
				   <s:elseif test='presentDetails.lotno=="J00013"'>竞足让球胜平负</s:elseif>
					...
					<td><s:if test='presentDetails.lotno=="J00001"||presentDetails.lotno=="J00013"'>-</s:if><s:else><s:property value="presentDetails.batchcode"/></s:else></td>
					<td><s:property value="presentDetails.nickName"/></td>
					<td>¥<s:property value="torder.amt"/></td>
					<td><s:property value="presentDetails.createtime"/></td>
					<td>
