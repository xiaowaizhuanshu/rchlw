		...
		<s:iterator value="#duizhen" status="stat" id="duizhenChidren">
			<s:if test="peilv.letVs.letPoint!=''&&peilv.letVs.v3!=''&&peilv.letVs.v1!=''&&peilv.letVs.v0!=''">
				...
				<tr id="tr_<s:property value="day"/>_<s:property value="#stat.count"/>" class="<s:if test="#stat.even">zucai_tr1</s:if>" style="background:${o1.odd?#FFFFFF:#F9F9F9 };">
	              ...
	              <td class="tzcursx" width="35" id="no_<s:property value="day"/>_<s:property value="#stat.count"/>" class="zucai_biao5" width="25"><s:property value="teamid"/></td>              
	              <td class="zucai_biao9 league" width="100" style=""><s:property value="league"/></td>
	              <td class="zucai_biao9" width="55"><s:property value="starttime"/></td>
	              <td id="hteam_<s:property value="day"/>_<s:property value="#stat.count"/>" class="zucai_biao6" width="100">
<!-- 						<a href="http://info.sporttery.com/football/info/fb_match_info.php?m=43519" target="_blank"  -->
<%-- 						title="<s:property value="team1"/>"><s:property value="hteam"/></a>  --%>
...
onmouseout="PopupOff($(this));" onmouseover="PopupOn($(this));"><s:property value="hteam"/></a>
	              ...
	              <td class="zucai_biao5 rangfenshu" style="text-align: center; border-left:1px solid #D5D5D5;"  width="20">
	                	<s:property value="peilv.letVs.letPoint"/>
	              </td>
	              <td id="vteam_<s:property value="day"/>_<s:property value="#stat.count"/>" class="zucai_biao5" width="100">
<%-- 	               	<a href="http://info.sporttery.com/football/info/fb_match_info.php?m=43519" target="_blank" title="<s:property value="team2"/>"><s:property value="kteam"/></a>  --%>
...
onmouseout="PopupOff($(this));" onmouseover="PopupOn($(this));"><s:property value="kteam"/></a>
	              ...
	              <td width="50">析 亚 欧</td>
					<td> 
					    <span id="ball3_<s:property value="day"/>_<s:property value="#stat.count"/>" class="result_3" onclick="checkColorButton($(this),<s:property value="day"/>,3,<s:property value="#stat.count"/>,'<s:property value="newweek"/>');">
							<s:property value="peilv.letVs.v3"/>                                                                                              
						</span>  
					    <span id="ball1_<s:property value="day"/>_<s:property value="#stat.count"/>" class="result_3" onclick="checkColorButton($(this),<s:property value="day"/>,1,<s:property value="#stat.count"/>,'<s:property value="newweek"/>');">
							<s:property value="peilv.letVs.v1"/>                                                                                       
						</span>   
						<span id="ball0_<s:property value="day"/>_<s:property value="#stat.count"/>" class="result_3" onclick="checkColorButton($(this),<s:property value="day"/>,0,<s:property value="#stat.count"/>,'<s:property value="newweek"/>');">
							<s:property value="peilv.letVs.v0"/> 
						</span>
				   </td>
				   <td  class="zucai_biao5" width="25" style="border-right:none;">
				  		<a href="javascript:void(0)" id="checkbox_<s:property value="day"/>_<s:property value="#stat.count"/>" onclick="changeColorCheckbox(<s:property value="day"/>,<s:property value="#stat.count"/>,'<s:property value="newweek"/>');">包</a>
				   </td>
				</tr>
