					...
					<div class="wjsctopTwo">
						...
						<ul class="wjsctopTwoR">
							...
							<p style="position:relative">
								...
								<input type="button" value="上传" name="" class="shangchuan" onclick="return jc_ajaxFileUpload('upload',getType());"><a class="biaozhun" target="_blank" href="<%=request.getContextPath() %>/function/ruyicai_jc/jc_spf_upload_geshi.html">查看标准格式样式</a>
							</p>
