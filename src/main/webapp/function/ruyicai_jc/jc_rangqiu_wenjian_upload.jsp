...
<div class="jzdqcurmidbot-c">
					...
					<div class="wjsctopOne">
						<h3><span>（最多可选15场，，下面所示的时间为开赛时间，红色数字表示让球数）</span>第一步 选择场次</h3>
					...
					<div class="wjsctopTwo">
						...
						<ul class="wjsctopTwoR">
							...
							<p style="position:relative">
								...
								<input type="button" value="上传" name="" class="shangchuan" onclick="return jc_ajaxFileUpload('upload',getType());"><a class="biaozhun" target="_blank" href="<%=request.getContextPath() %>/function/ruyicai_jc/jc_rangqiu_upload_geshi.html">查看标准格式样式</a>
							</p>
