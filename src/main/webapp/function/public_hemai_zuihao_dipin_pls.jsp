...
<%@taglib prefix="s" uri="/struts-tags"%>
		<div class="FollowNub"><!-- 追号 start -->
			<dl class="ChannelBuyTab FollowNubTab">
				...
				<dd class="TabEm" id="ZhuiHao" style="display: none"><a  target="_blank" href='http://www.ruyicai.com/cms/a/bangzhuzhongxin/goumaicaipiao/2012/0331/61.html?id=17'>连续多期购买同一个（组）号码</a></dd>
			</dl>
					...
					<tr>
						...
						<td style="padding-right:0px;">
							<ul>
								...
								我已阅读并同意<span class="buy_blue"><a href="/rchlw/function/rules/pls_RiskFile.jsp" title="限号管理" target="_blank">限号管理</a></span>和<a href="/rchlw/function/rules/pls_RiskFile.jsp" title="投注风险须知议" target="_blank">《排列三投注风险须知》</a>。</li>
							</ul>
						</td>
