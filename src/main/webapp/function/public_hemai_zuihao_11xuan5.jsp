...
<%@taglib prefix="tangs" uri="/WEB-INF/tangs.tld" %>
		...
		<div class="FollowNub"><!-- 追号 start -->
			...
			<dl class="ChannelBuyTab FollowNubTab">
				...
				<dd class="TabEm" id="ZhuiHao" style="display: none"><a  target="_blank" href="http://www.ruyicai.com/cms/a/bangzhuzhongxin/goumaicaipiao/2012/0331/64.html?id=17">什么叫收益率追号？</a></dd>
