...
<%@taglib prefix="tangs" uri="/WEB-INF/tangs.tld" %>
		...
		<div class="FollowNub"><!-- 追号 start -->
			...
			<dl class="ChannelBuyTab FollowNubTab">
				...
				<dd class="TabEm" id="ZhuiHao" style="display: none"><a  target="_blank" href="<%=com.boyacai.common.util.AppAddr.getRchlwPath() %>/cms/a/bangzhuzhongxin/goumaicaipiao/2012/0331/64.html?id=17">什么叫收益率追号？</a></dd>
					...
					<tr>
						...
						<td style="padding-right:0px;">
							<ul>
								...
								<li><input type="checkbox" checked="checked" id="fengxiang"/>我已阅读并同意<span class="buy_blue"><a href="/rchlw/function/rules/11xuan5Risk.jsp" title="限号管理" target="_blank">限号管理</a></span>和<a class="light" href="/rchlw/function/rules/11xuan5Risk.jsp" target="_blank">《江西11选5投注风险须知》</a>。</li>
							</ul>
						</td>
