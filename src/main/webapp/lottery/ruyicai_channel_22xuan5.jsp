...
<title>博雅彩22选5投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表</title>  
<meta http-equiv="keywords" content="22选5投注，22选5开奖公告，22选5开奖点评，22选5冷热号分析，体22选5奖金对照表，22选5走势图表"/>
<meta http-equiv="description" content="博雅彩22选5集投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表为一体是22选5一站式服务平台。"/>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/function/js/22xuan5/22xuan5.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='<%=request.getContextPath()%>/function/selectAll!getCaselotsByWhere?lotno=T01013'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
		 <script>$(function(){kaijiangBylotno('T01013','ChannelBuyBulletin');});</script>
		</div>
		<!--  22选5开奖公告 end  -->
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			<div class="ChannelBuyPannelHead"><h3>22选5图表走势</h3><a href="http://zst.boyacai.com/cjweexw/view/eexwsfq.php" title="更多"  target="_blank">更多&gt;&gt;</a></div>
			<div class="ChannelBuyPannelBody">
				<ul>
