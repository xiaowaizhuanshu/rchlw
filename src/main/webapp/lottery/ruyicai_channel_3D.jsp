...
<div class="ChannelBuyBody">
	...
	<div class="ChannelBuyInfo">
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			<div class="ChannelBuyPannelHead"><h3>福彩3D图表走势</h3><a href="http://zst.boyacai.com/cjw3d/index.php" title="更多"  target="_blank">更多&gt;&gt;</a></div>
			<div class="ChannelBuyPannelBody">
				<ul>
