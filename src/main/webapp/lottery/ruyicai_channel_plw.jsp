...
<title>博雅彩排列五投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表 </title>  
<meta http-equiv="keywords" content="排列五投注，排列五开奖公告，排列五开奖点评，排列五冷热号分析，排列五奖金对照表，排列五走势图表"/>
<meta http-equiv="description" content="博雅彩排列五集投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表为一体是排列五一站式服务平台。"/>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/function/js/plw/plw.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<ol style="background:url(<%=request.getContextPath() %>/function/images/logo_plw_d.gif) no-repeat 15px 15px;">
				<li>
					...
					<img src="<%=request.getContextPath() %>/function/images/word_plw.gif" /><i>当前期第<strong id="qihao"></strong>期　天天开奖，固定奖金10万元！　</i><img src="<%=request.getContextPath() %>/function/images/jrkaijiang.gif" />
				</li>	
				<li>
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='<%=request.getContextPath()%>/function/selectAll!getCaselotsByWhere?lotno=T01011'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
			  <script>$(function(){kaijiangBylotno('T01011','ChannelBuyBulletin');});</script>
		</div>
		<!--  排列5开奖公告 end  -->
		<div class="space10">&nbsp;</div>
		<!--  排列5上期开奖点评 start  -->
	<div class="ChannelBuyPannel ChannelBuyReview">
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			<div class="ChannelBuyPannelHead"><h3>排列5图表走势</h3><a href="http://zst.boyacai.com/cjwpl5/view/pl5_zst.php" title="更多"  target="_blank">更多&gt;&gt;</a></div>
			<div class="ChannelBuyPannelBody">
				<ul>
