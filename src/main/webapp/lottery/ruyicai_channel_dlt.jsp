...
<script type="text/javascript" src="<%=request.getContextPath() %>/function/js/dlt/dlt.js"></script>
...
<body onload="dltZhuijiaNone();hemaiInit();zengcaiInit();">
		...
		<div class="ChannelBuyBanner">
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='<%=request.getContextPath()%>/function/selectAll!getCaselotsByWhere?lotno=T01001'">参与合买</dt>
...
<!-- 				</div> -->
            ...
            <input type="hidden"id="urlAdd" value="/rchlw/lottery/ruyicai_channel_dlt.jsp" name="urlAdd">
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
		 <script>$(function(){kaijiangBylotno('T01001','ChannelBuyBulletin');});</script>
		</div>
		<!--  大乐透开奖公告 end  -->
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			<div class="ChannelBuyPannelHead"><h3>大乐透图表走势</h3><a href="http://zst.boyacai.com/cjwdlt/view/dltyqsfq.php" title="更多"  target="_blank">更多&gt;&gt;</a></div>
			<div class="ChannelBuyPannelBody">
				<ul>
